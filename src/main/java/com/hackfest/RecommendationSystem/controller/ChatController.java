...
import com.hackfest.RecommendationSystem.entity.Message;
...
public class ChatController  {
    ...
    @MessageMapping("/message") // to listen /app/message
    @SendTo("/chatroom/public")
    private Message recievePublicMessage(@Payload Message message){
        return message;
    }

    @MessageMapping("private-message") // to listen /user/username/private
